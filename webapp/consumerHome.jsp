...
<body>
    ...
    <h1>Welcome, <%= consumer.getConsumerName() %>!</h1>
            <table>
                <tr>
                    <th>Consumer ID</th>
                    <td><h:outputText value="<%= consumer.getConsumerId() %>"/></td>
                </tr>
                <tr>
                    <th>Name</th>
                    <td><h:outputText value="$<%= consumer.getConsumerName() %>"/></td>
                </tr>
                <tr>
                    <th>Email</th>
                    <td><h:outputText value="<%= consumer.getConsumerEmail() %>"/></td>
                </tr>
                <tr>
                    <th>Password</th>
                ...
                <tr>
                    ...
                    <td><h:outputText value="$<%= consumer.getSubscriber() %>"/></td>
                </tr>
            </table>
            <p><a href="Home.jsp">Go Home</a></p>
            <form action="DisplayPurchaseItemsServlet" method="get">
